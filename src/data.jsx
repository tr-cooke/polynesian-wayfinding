...
export const MODULE_CONTENT = {
  ...
  2: {
    ...
    destination: "Tahiti",
    departure: { location: "Apia, Sāmoa", note: "The harbour at sunrise. Palu stands on the shore and traces the sun's arc across the sky with his hand." },
    intro: {
    ...
    learn: {
      ...
      concepts: [
        ...
        { heading: "Reading the noon sun", body: "At the equinox, the noon sun peaks on the celestial equator. The farther south you sail, the farther it falls short of directly overhead. Palu calibrated his hand before leaving Tonga: at arm's length, three fingers above the horizon is roughly 6°. He has memorised the height of the noon sun that belongs to Tahiti. When Tama-nui-te-rā stands at that height, we are on ʻAʻā's path. No formula. Just a shape in the sky he knows by heart." },
      ],
    },
  },
  3: {

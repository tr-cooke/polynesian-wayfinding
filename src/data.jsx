...
export const MODULE_CONTENT = {
  1: {
    ...
    learn: {
      ...
      concepts: [
        { heading: "Using the Stars", body: "Your first skill will be to learn the stars to help you navigate. In the north, sailors follow Polaris — the north star — because it sits directly above the Earth's pole and barely moves. From Tonga, Polaris sits well below our horizon — invisible from Tonga. We cannot use it. There is no bright star above the south pole either. So our ancestors asked a different question: not 'which star stays still?' but 'what about a star never changes?'" },
  ...
  2: {
    ...
    intro: {
      quote: "Great work on our first voyage. The Samoan wayfinders were impressed — they shared their star maps with us, and a story about how their ancestors first found Tahiti — how the navigator Rata followed ʻAʻā, the brightest star in the sky, south-southeast until it rose directly overhead, and knew he had arrived. That star, they told us, belongs to Tahiti. Remember that name. Now for a new challenge: the stars are not always visible. We need to learn the sky by day as well as by night. Our next destination is Tahiti, and the sun will help us find it.",

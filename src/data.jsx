...
export const BRIDGE_CONTENT = {
  ...
  2: {
    ...
    paluLines: [
      ...
      "I traveled here once when I was not much older than you. The old Wayfinding master who taught me — Tū-te-rangi-ātea — he held court on Raʻiatea, the sacred island just to the west. He has passed on now. But his successor still tends the marae.",
      "We will share what we have brought and see what knowledge lives here. The sun guided us well.",
    ],
    storyTitle: "Tama-nui-te-rā",
    story: "Māui, the great trickster, lassoed the sun with his grandmother's jawbone to slow its crossing of the sky — giving the people more daylight to dry their fish and finish their work. Navigators tell a version of this story too: the sun at the solstice barely moves in altitude for days. That stillness is a gift. A long, stable noon altitude means a long, reliable latitude fix — days of the same reading instead of one.",
    storyCitation: "Māui cycle, Polynesian oral tradition",
    bagItems: ["sun_arc"],
    bagNote: "The sun arc joins your bag — a mental instrument. No sextant, no quadrant. Just the angle of your arm and the knowledge of the season.",
    bridgeLine: "Rest here two nights. Then we sail northeast — the Marquesas. The swells up there will feel different. I will teach you to read them.",
  },
  3: {
    destination: "Marquesas",
    arrivalScene: "🌊",
    paluLines: [
      "Swell work! Three days of that ocean — you earned your rest.",
      "I have old friends ashore here. Tonight we join them for dinner and stories around the fire. They will want to hear about Tonga, and about you.",
      "The new wayfarer here — a young woman named Hina — gifted us a cutting from a drought-resistant taro. We carry it carefully. It needs water each day.",
    ],
    storyTitle: "Reading by Feel",
    story: "Mau Piailug — Mau of Satawal — could read two separate swell trains simultaneously while lying in the hull of Hōkūleʻa with his eyes closed. He learned this as a child, sleeping on the outrigger platform of his father's canoe, letting the sea teach his body before his mind could interfere. He said a navigator who must think about the swell has not yet learned it. When it is known, it is simply there — like breathing.",
    storyCitation: "Ben Finney, Voyage of Rediscovery, 1994",
    bagItems: ["wave_reader", "taro_plant"],
    bagNote: "The wave reader joins your bag — and so does the taro cutting from Hina of the Marquesas. Keep it watered. We carry living knowledge home.",
    bridgeLine: "Two nights here, then northwest. Hawaiʻi. The longest crossing of the voyage — and we must cross the doldrums to get there. I will explain in the morning.",
  },
  4: {
    destination: "Hawaiʻi",
    arrivalScene: "🌺",
    paluLines: [
      "The ITCZ gave us a hard two days — calms and squalls and confused wind. But you held your nerve and we are through.",
      "I can see the first island now. Hawaiʻi. The NE trades brought us in exactly where we planned. Your parents will be proud.",
      "We will rest ashore tonight. Tomorrow we share our sweet potato seeds with the chiefs here — then sleep. Real sleep, in a real bed.",
    ],
    storyTitle: "The Wind Has Names",
    story: "In Pacific tradition, naming the wind is not poetry — it is navigation. Hau, Matagi, Tokelau, Rēhia — each name carries information about season, bearing, and what the wind means for a voyage. A navigator who knows the names knows what each wind will do next and where it has come from. Unnamed wind is dangerous wind. When Palu Hemi tells you to learn the wind's names, he is telling you to study its patterns until they have the solidity of facts.",
    storyCitation: "Pacific voyaging oral tradition",
    bagItems: ["wind_reader"],
    bagNote: "The wind reader is yours now. Trade winds, ITCZ, El Niño shifts — all in your bag. You have crossed the longest passage of the voyage.",
    bridgeLine: "From here we swing southwest to Fiji. A shorter crossing — and the birds will guide us in. Watch what flies.",
  },
  5: {
    destination: "Fiji",
    arrivalScene: "🐦",
    paluLines: [
      "The ʻiwa did not return. It found Fiji before we could see it — that is how it should work.",
      "Matala has been restless all morning. She knew we were close too. Birds always know.",
      "Come — let us go ashore and share our last sweet potato seeds. And hear what is new here. The Fijian navigators have a different ocean tradition — there is always something to learn.",
    ],
    storyTitle: "Kuramārōtini Sights Land",
    story: "When Kupe sailed south from Hawaiki to find Aotearoa, it was his wife Kuramārōtini who first called land. She had watched the birds for three days — the white terns flying inland at dusk, returning seaward at dawn — before the mountains appeared. \"He ao! He ao tea!\" she called. A cloud! A white cloud! But Kupe knew she meant more than cloud. She had already read the birds. The cloud was confirmation.",
    storyCitation: "Kupe narrative, Māori oral tradition",
    bagItems: ["bird_guide"],
    bagNote: "The bird guide is complete and in your bag — every species, every signal. Manu-o-kū, Noio, ʻIwa, Kōlea, Koekoea. Read what flies.",
    bridgeLine: "Southwest now — home. Tonga is waiting. We carry new stories, new seeds, a star map, and a taro cutting. Use the clouds and the sea itself to bring us in.",
  },
  6: {
    destination: "Tonga",
    arrivalScene: "⚓",
    paluLines: [
      "There — the standing cloud. Do you see it? Still, while the rest move. That is our island. That is home.",
      "We left with sweet potato seeds. We return with a Samoan star map, a Marquesan taro cutting, new friendships, and a fully trained wayfinder.",
      "You have become a real wayfinder, " + "{{name}}" + ". What a journey. Pull the canoe ashore — but do not put up your feet just yet. I have heard something happened while we were away.",
    ],
    ...
    bridgeLine: "Rest tonight. Tomorrow we hear what has happened — and then we may face one more voyage.",
  },
};
...
export const MODULE_CONTENT = {
  ...
  2: {
    ...
    learn: {
      title: "The Sun's Arc",
      concepts: [
        { heading: "Local noon", body: "Once each day the sun reaches its highest point in the sky — local noon. At this moment it stands due north (in the southern hemisphere), giving you a perfect bearing." },
        { heading: "Latitude formula", body: "At the equinox: your latitude = 90° minus the sun's noon altitude. Measure the angle between the sun and the horizon and subtract from 90. No instruments needed — angle your arm." },
        { heading: "Seasonal correction", body: "At the summer solstice the sun is 23.5° higher than at the equinox. At the winter solstice, 23.5° lower. Know the season, know the correction. The formula becomes: latitude = 90° − altitude ± 23.5°." },
        { heading: "Sunrise and sunset", body: "At the equinox, the sun rises due east and sets due west everywhere on earth. Use these moments for bearing checks. At midday the sun is too high to give direction — only altitude." },
      ],
    },
  },
  3: {
  ...
  4: {
    ...
    learn: {
      ...
      concepts: [
        ...
        { heading: "El Niño", body: "Every few years El Niño shifts the ITCZ south and weakens the SE trades. The crossing window changes, the doldrums widen, the familiar wind calendar no longer applies. Navigators who knew this changed their departure month, not their route." },
      ],
    },
  },
  5: {
